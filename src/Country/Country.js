...
function YourCountry({navigation}) {
    ...
    <View style={{ flex: 1 }}>
      <View style={{ backgroundColor: "#243447", padding: 20 }}>
        <Text style={styles.paragraph}>
          Your country's elections will be held on Monday, April the 15th, 2020.
          Polls will be open from 8am - 5pm. Don't forget to set a reminder.
        </Text>
        <Text style={styles.paragraph}>
          Your country will require that you bring these forms of id: - driver's
...
export function CountryStack({ navigation: { goBack } }) {
         return (
           <View style={{ flex: 1 }}>
             <Stack.Navigator
               initialRouteName="Your Country"
               screenOptions={{
                 headerLeft: () => (
             ...
             >
               <Stack.Screen name="Your Country" component={YourCountry} />
